        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreNaam = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Beschrijving = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Kleur = table.Column<string>(type: "TEXT", maxLength: 7, nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Geboortejaar = table.Column<int>(type: "INTEGER", nullable: true),
                    Nationaliteit = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Biografie = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Releasejaar = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    CoverAfbeelding = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Rating = table.Column<double>(type: "REAL", nullable: false),
                    RegisseurId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Films_AspNetUsers_AddedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FilmId = table.Column<int>(type: "INTEGER", nullable: false),
                    GenreId = table.Column<int>(type: "INTEGER", nullable: false),
                    FilmGenreId = table.Column<int>(type: "INTEGER", nullable: false),
